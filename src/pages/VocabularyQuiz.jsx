...
const quizData = {
  easy: [
    ...
    { question: "What is the opposite of 'big'?", options: ["Small", "Huge", "Fast", "Short"], answer: "Small" },
    { question: "Which word means 'to speak'?", options: ["Talk", "Walk", "Sleep", "Eat"], answer: "Talk" },
    { question: "What is the synonym of 'beautiful'?", options: ["Ugly", "Pretty", "Boring", "Sad"], answer: "Pretty" },
    { question: "What is the opposite of 'hot'?", options: ["Warm", "Cold", "Tepid", "Boiling"], answer: "Cold" }
  ],
  medium: [
    { question: "Which word means 'a place where books are kept'?", options: ["Library", "Museum", "Garden", "Theater"], answer: "Library" },
    { question: "What is the synonym of 'brave'?", options: ["Cowardly", "Fearless", "Weak", "Lazy"], answer: "Fearless" },
    { question: "What does 'ambiguous' mean?", options: ["Clear", "Uncertain", "Definite", "Simple"], answer: "Uncertain" },
    { question: "Which word means 'to look at written words and understand them'?", options: ["Write", "Speak", "Read", "Listen"], answer: "Read" },
    { question: "What is the opposite of 'generous'?", options: ["Kind", "Giving", "Stingy", "Wealthy"], answer: "Stingy" }
  ],
  hard: [
    { question: "What does 'ephemeral' mean?", options: ["Eternal", "Short-lived", "Strong", "Loud"], answer: "Short-lived" },
    { question: "Which word means 'a deep, narrow valley'?", options: ["Canyon", "Plateau", "Desert", "Hill"], answer: "Canyon" },
    { question: "What is the synonym of 'ubiquitous'?", options: ["Rare", "Omnipresent", "Unusual", "Hidden"], answer: "Omnipresent" },
    { question: "What does 'loquacious' mean?", options: ["Silent", "Talkative", "Angry", "Sleepy"], answer: "Talkative" },
    { question: "Which word means 'to make something less severe'?", options: ["Aggravate", "Mitigate", "Complicate", "Accelerate"], answer: "Mitigate" }
  ]
};
