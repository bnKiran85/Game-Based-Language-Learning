...
const words = [
  { word: "banana", hint: "A yellow fruit that monkeys love", difficulty: "easy", category: "Food" },
  { word: "mountain", hint: "A tall landform with a peak", difficulty: "medium", category: "Nature" },
  { word: "pencil", hint: "A tool used for writing or drawing", difficulty: "easy", category: "Objects" },
  { word: "elephant", hint: "A large animal with a trunk", difficulty: "medium", category: "Animals" },
  { word: "moon", hint: "A celestial body that orbits the Earth", difficulty: "easy", category: "Space" },
  { word: "computer", hint: "An electronic device for processing data", difficulty: "medium", category: "Technology" },
  { word: "ocean", hint: "A vast body of saltwater", difficulty: "easy", category: "Nature" },
  { word: "guitar", hint: "A musical instrument with strings", difficulty: "medium", category: "Music" },
  { word: "volcano", hint: "A mountain that erupts with lava", difficulty: "hard", category: "Nature" },
  { word: "chocolate", hint: "A sweet treat made from cocoa", difficulty: "easy", category: "Food" },
  { word: "astronaut", hint: "A person who travels to space", difficulty: "medium", category: "Space" },
  { word: "bridge", hint: "A structure that connects two places", difficulty: "easy", category: "Objects" },
  { word: "tornado", hint: "A violent rotating column of air", difficulty: "hard", category: "Weather" },
  { word: "camera", hint: "A device used to capture images", difficulty: "easy", category: "Technology" },
  { word: "dolphin", hint: "An intelligent marine mammal", difficulty: "medium", category: "Animals" },
  { word: "pyramid", hint: "An ancient structure in Egypt", difficulty: "hard", category: "History" },
  { word: "keyboard", hint: "An input device for typing", difficulty: "easy", category: "Technology" },
  { word: "whale", hint: "The largest animal in the ocean", difficulty: "medium", category: "Animals" },
  { word: "sunflower", hint: "A tall plant with yellow petals", difficulty: "easy", category: "Nature" },
  { word: "firefighter", hint: "A person who extinguishes fires", difficulty: "medium", category: "Profession" },
  { word: "avalanche", hint: "A mass of snow falling rapidly", difficulty: "hard", category: "Nature" },
  { word: "helicopter", hint: "An aircraft with rotating blades", difficulty: "medium", category: "Transportation" },
  { word: "library", hint: "A place where books are stored", difficulty: "easy", category: "Places" },
  { word: "gravity", hint: "A force that pulls objects downward", difficulty: "medium", category: "Science" },
  { word: "galaxy", hint: "A large system of stars and planets", difficulty: "hard", category: "Space" },
  { word: "cactus", hint: "A desert plant with spines", difficulty: "easy", category: "Nature" },
  { word: "microscope", hint: "A device used to view tiny objects", difficulty: "hard", category: "Science" },
  { word: "rainbow", hint: "A colorful arc after rain", difficulty: "easy", category: "Weather" },
  { word: "satellite", hint: "An object orbiting a planet", difficulty: "medium", category: "Space" },
  { word: "sculpture", hint: "A 3D artwork made from materials", difficulty: "medium", category: "Art" },
  { word: "chess", hint: "A strategic board game with pieces", difficulty: "medium", category: "Games" },
  { word: "telescope", hint: "An instrument used to see distant objects", difficulty: "hard", category: "Science" },
  { word: "island", hint: "A piece of land surrounded by water", difficulty: "easy", category: "Geography" },
  { word: "electricity", hint: "A form of energy used in homes", difficulty: "medium", category: "Science" },
  { word: "penguin", hint: "A bird that cannot fly and lives in Antarctica", difficulty: "medium", category: "Animals" },
  { word: "airplane", hint: "A vehicle that flies in the sky", difficulty: "easy", category: "Transportation" },
  { word: "coral", hint: "A marine organism that forms reefs", difficulty: "medium", category: "Nature" },
  { word: "notebook", hint: "A book used for writing notes", difficulty: "easy", category: "Objects" },
  { word: "tiger", hint: "A big cat with orange fur and black stripes", difficulty: "medium", category: "Animals" },
  { word: "tornado", hint: "A destructive windstorm", difficulty: "hard", category: "Weather" },
  { word: "jigsaw", hint: "A puzzle made of interlocking pieces", difficulty: "medium", category: "Games" },
  { word: "oxygen", hint: "A gas essential for breathing", difficulty: "easy", category: "Science" },
  { word: "violin", hint: "A small string instrument played with a bow", difficulty: "medium", category: "Music" },
  { word: "hot air balloon", hint: "A large balloon used for flying", difficulty: "hard", category: "Transportation" },
  { word: "fossil", hint: "Preserved remains of ancient organisms", difficulty: "hard", category: "Science" },
  { word: "football", hint: "A popular sport played with a round ball", difficulty: "easy", category: "Sports" },
  { word: "painter", hint: "A person who creates artwork using colors", difficulty: "medium", category: "Art" },
  { word: "bicycle", hint: "A two-wheeled vehicle powered by pedals", difficulty: "easy", category: "Transportation" }
];
